<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    $emp_result = mysqli_query($con,$emp);
    ...
    <div class="row">
        <div class="col-sm-12">
        <p class="back-link"><b> © 2022 All rights reserved. Made with &#x1F49C; by <a href="https://www.youtube.com/channel/UC4_6-VSWBw_QHMyjrDDEvVQ"> GPW</a> Team.</b> </p>
        </div>
    </div>
